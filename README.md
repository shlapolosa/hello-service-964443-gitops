# hello-service-964443 GitOps Repository

This repository contains the GitOps deployment manifests for the hello-service-964443 application container.

## Structure

```
hello-service-964443-gitops/
